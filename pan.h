...
#define PanSource	"ModeleDetaille.pml"
...
#define _nstates10	21	/* p8 */
#define minseq10	260
#define maxseq10	279
#define _endstate10	20

#define _nstates9	11	/* p7 */
#define minseq9	250
#define maxseq9	259
#define _endstate9	10

#define _nstates8	35	/* p6 */
#define minseq8	216
#define maxseq8	249
#define _endstate8	34

#define _nstates7	21	/* p5 */
#define minseq7	196
#define maxseq7	215
#define _endstate7	20

#define _nstates6	35	/* p4 */
#define minseq6	162
#define maxseq6	195
#define _endstate6	34

#define _nstates5	51	/* p3 */
#define minseq5	112
#define maxseq5	161
#define _endstate5	50

#define _nstates4	11	/* p0 */
#define minseq4	102
#define maxseq4	111
#define _endstate4	10

#define _nstates3	11	/* pp */
#define minseq3	92
#define maxseq3	101
...
#define _nstates1	45	/* Rame2 */
#define minseq1	44
#define maxseq1	87
#define _endstate1	44

#define _nstates0	45	/* Rame1 */
#define minseq0	0
#define maxseq0	43
#define _endstate0	44
...
#define PRame2	((P1 *)this)
typedef struct P1 { /* Rame2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, dirR2) - 1*sizeof(int))

#define PRame1	((P0 *)this)
typedef struct P0 { /* Rame1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 7; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, dirR2) - 1*sizeof(int))
...
#else
	#define ACCEPT_LAB	20 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
...
#endif
#define PROG_LAB	8 /* progress labels */
#define NQS	4
typedef struct Q4 {
	uchar Qlen;	/* q_size */
	uchar _t;	/* q_type */
