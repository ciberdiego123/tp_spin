...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 2: /* generic 'else' */
		...
		_m = 3; goto P999;
		 ...
		 /* CLAIM p6 */
	case 3: // STATE 1 - _spin_nvr.tmp:87 - [(!(((posR2>=1)&&(posR2<=NS))))] (0:0:0 - 1)
		...
		if (!( !(((now.posR2>=1)&&(now.posR2<=now.NS)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 4: // STATE 3 - _spin_nvr.tmp:88 - [(!(((posR1>=1)&&(posR1<=NS))))] (0:0:0 - 1)
		...
		if (!( !(((now.posR1>=1)&&(now.posR1<=now.NS)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 5: // STATE 5 - _spin_nvr.tmp:89 - [(!(((dirR2==1)||(dirR2==-(1)))))] (0:0:0 - 1)
		...
		if (!( !(((now.dirR2==1)||(now.dirR2== -(1))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 6: // STATE 7 - _spin_nvr.tmp:90 - [(!(((dirR1==1)||(dirR1==-(1)))))] (0:0:0 - 1)
		...
		if (!( !(((now.dirR1==1)||(now.dirR1== -(1))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 7: // STATE 14 - _spin_nvr.tmp:95 - [(!(((posR2>=1)&&(posR2<=NS))))] (0:0:0 - 1)
		...
		if (!( !(((now.posR2>=1)&&(now.posR2<=now.NS)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 8: // STATE 19 - _spin_nvr.tmp:99 - [(!(((posR1>=1)&&(posR1<=NS))))] (0:0:0 - 1)
		...
		if (!( !(((now.posR1>=1)&&(now.posR1<=now.NS)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 9: // STATE 24 - _spin_nvr.tmp:103 - [(!(((dirR2==1)||(dirR2==-(1)))))] (0:0:0 - 1)
		...
		if (!( !(((now.dirR2==1)||(now.dirR2== -(1))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 29 - _spin_nvr.tmp:107 - [(!(((dirR1==1)||(dirR1==-(1)))))] (0:0:0 - 1)
	...
	case 11: // STATE 34 - _spin_nvr.tmp:109 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* CLAIM p5 */
	case 12: // STATE 1 - _spin_nvr.tmp:71 - [((!(!(((posR2<(NS-1))&&(dirR2==1))))&&!((posR2==(NS-1)))))] (0:0:0 - 1)
...
#endif
		reached[4][1] = 1;
		if (!(( !( !(((now.posR2<(now.NS-1))&&(now.dirR2==1))))&& !((now.posR2==(now.NS-1))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 3 - _spin_nvr.tmp:72 - [((!(!(((posR1<(NS-1))&&(dirR1==1))))&&!((posR1==(NS-1)))))] (0:0:0 - 1)
...
#endif
		reached[4][3] = 1;
		if (!(( !( !(((now.posR1<(now.NS-1))&&(now.dirR1==1))))&& !((now.posR1==(now.NS-1))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 14: // STATE 10 - _spin_nvr.tmp:77 - [(!((posR2==(NS-1))))] (0:0:0 - 1)
...
#endif
		reached[4][10] = 1;
		if (!( !((now.posR2==(now.NS-1)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 15 - _spin_nvr.tmp:81 - [(!((posR1==(NS-1))))] (0:0:0 - 1)
	...
	case 16: // STATE 20 - _spin_nvr.tmp:83 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* CLAIM p4 */
	case 17: // STATE 1 - _spin_nvr.tmp:45 - [(((!(!(((posR2<NS)&&(dirR2==1))))&&!((posR2==NS)))&&(!(!(((posR1<NS)&&(dirR1==1))))||(!(!(((posR1>1)&&(dirR1==-(1)))))||(!(!(((posR2<NS)&&(dirR2==1))))||!(!(((posR2>1)&&(dirR2==-(1))))))))))] (0:0:0 - 1)
...
#endif
		reached[3][1] = 1;
		if (!((( !( !(((now.posR2<now.NS)&&(now.dirR2==1))))&& !((now.posR2==now.NS)))&&( !( !(((now.posR1<now.NS)&&(now.dirR1==1))))||( !( !(((now.posR1>1)&&(now.dirR1== -(1)))))||( !( !(((now.posR2<now.NS)&&(now.dirR2==1))))|| !( !(((now.posR2>1)&&(now.dirR2== -(1)))))))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 18: // STATE 3 - _spin_nvr.tmp:46 - [(((!(!(((posR2>1)&&(dirR2==-(1)))))&&!((posR2==1)))&&(!(!(((posR1<NS)&&(dirR1==1))))||(!(!(((posR1>1)&&(dirR1==-(1)))))||(!(!(((posR2<NS)&&(dirR2==1))))||!(!(((posR2>1)&&(dirR2==-(1))))))))))] (0:0:0 - 1)
...
#endif
		reached[3][3] = 1;
		if (!((( !( !(((now.posR2>1)&&(now.dirR2== -(1)))))&& !((now.posR2==1)))&&( !( !(((now.posR1<now.NS)&&(now.dirR1==1))))||( !( !(((now.posR1>1)&&(now.dirR1== -(1)))))||( !( !(((now.posR2<now.NS)&&(now.dirR2==1))))|| !( !(((now.posR2>1)&&(now.dirR2== -(1)))))))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 19: // STATE 5 - _spin_nvr.tmp:47 - [((!(!(((posR1<NS)&&(dirR1==1))))&&!((posR1==NS))))] (0:0:0 - 1)
...
#endif
		reached[3][5] = 1;
		if (!(( !( !(((now.posR1<now.NS)&&(now.dirR1==1))))&& !((now.posR1==now.NS)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 20: // STATE 7 - _spin_nvr.tmp:48 - [((!(!(((posR1>1)&&(dirR1==-(1)))))&&!((posR1==1))))] (0:0:0 - 1)
...
#endif
		reached[3][7] = 1;
		if (!(( !( !(((now.posR1>1)&&(now.dirR1== -(1)))))&& !((now.posR1==1)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 21: // STATE 14 - _spin_nvr.tmp:53 - [(!((posR2==NS)))] (0:0:0 - 1)
		...
		if (!( !((now.posR2==now.NS))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 22: // STATE 19 - _spin_nvr.tmp:57 - [(!((posR2==1)))] (0:0:0 - 1)
		...
		if (!( !((now.posR2==1))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 23: // STATE 24 - _spin_nvr.tmp:61 - [(!((posR1==NS)))] (0:0:0 - 1)
		...
		if (!( !((now.posR1==now.NS))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 24: // STATE 29 - _spin_nvr.tmp:65 - [(!((posR1==1)))] (0:0:0 - 1)
	...
	case 25: // STATE 34 - _spin_nvr.tmp:67 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* CLAIM p3 */
	case 26: // STATE 1 - _spin_nvr.tmp:12 - [(((!(!(((posR2!=NS)&&(dirR2==1))))&&!(((posR2==NS)&&(dirR2==-(1)))))&&(!(!(((posR1!=1)&&(dirR1==-(1)))))||(!(!(((posR1!=NS)&&(dirR1==1))))||(!(!(((posR2!=1)&&(dirR2==-(1)))))||!(!(((posR2!=NS)&&(dirR2==1)))))))))] (0:0:0 - 1)
		...
		if (!((( !( !(((now.posR2!=now.NS)&&(now.dirR2==1))))&& !(((now.posR2==now.NS)&&(now.dirR2== -(1)))))&&( !( !(((now.posR1!=1)&&(now.dirR1== -(1)))))||( !( !(((now.posR1!=now.NS)&&(now.dirR1==1))))||( !( !(((now.posR2!=1)&&(now.dirR2== -(1)))))|| !( !(((now.posR2!=now.NS)&&(now.dirR2==1))))))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 27: // STATE 3 - _spin_nvr.tmp:13 - [((((!(!(((posR1!=1)&&(dirR1==-(1)))))&&!(((posR1==1)&&(dirR1==1))))&&!((dirR1==-(1))))||(((!(!(((posR1!=NS)&&(dirR1==1))))&&!(((posR1==NS)&&(dirR1==-(1)))))&&!((dirR1==1)))||(((!(!(((posR2!=1)&&(dirR2==-(1)))))&&!(((posR2==1)&&(dirR2==1))))&&!((dirR2==-(1))))||((!(!(((posR2!=NS)&&(dirR2==1))))&&!(((posR2==NS)&&(dirR2==-(1)))))&&!((dirR2==1)))))))] (14:0:0 - 1)
		...
		;
		_m = 3; goto P999; /* 2 */
	case 28: // STATE 6 - _spin_nvr.tmp:14 - [(((!(!(((posR2!=1)&&(dirR2==-(1)))))&&!(((posR2==1)&&(dirR2==1))))&&(!(!(((posR1!=1)&&(dirR1==-(1)))))||(!(!(((posR1!=NS)&&(dirR1==1))))||(!(!(((posR2!=1)&&(dirR2==-(1)))))||!(!(((posR2!=NS)&&(dirR2==1)))))))))] (0:0:0 - 1)
		...
		if (!((( !( !(((now.posR2!=1)&&(now.dirR2== -(1)))))&& !(((now.posR2==1)&&(now.dirR2==1))))&&( !( !(((now.posR1!=1)&&(now.dirR1== -(1)))))||( !( !(((now.posR1!=now.NS)&&(now.dirR1==1))))||( !( !(((now.posR2!=1)&&(now.dirR2== -(1)))))|| !( !(((now.posR2!=now.NS)&&(now.dirR2==1))))))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 29: // STATE 8 - _spin_nvr.tmp:15 - [((!(!(((posR1!=NS)&&(dirR1==1))))&&!(((posR1==NS)&&(dirR1==-(1))))))] (0:0:0 - 1)
		...
		if (!(( !( !(((now.posR1!=now.NS)&&(now.dirR1==1))))&& !(((now.posR1==now.NS)&&(now.dirR1== -(1)))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 30: // STATE 10 - _spin_nvr.tmp:16 - [((!(!(((posR1!=1)&&(dirR1==-(1)))))&&!(((posR1==1)&&(dirR1==1)))))] (0:0:0 - 1)
		...
		if (!(( !( !(((now.posR1!=1)&&(now.dirR1== -(1)))))&& !(((now.posR1==1)&&(now.dirR1==1))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 31: // STATE 17 - _spin_nvr.tmp:21 - [(!(((posR2==NS)&&(dirR2==-(1)))))] (0:0:0 - 1)
		...
		if (!( !(((now.posR2==now.NS)&&(now.dirR2== -(1))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 32: // STATE 19 - _spin_nvr.tmp:22 - [((!(((posR2==NS)&&(dirR2==-(1))))&&!((dirR2==1))))] (22:0:0 - 1)
		...
		;
		_m = 3; goto P999; /* 2 */
	case 33: // STATE 25 - _spin_nvr.tmp:26 - [(!(((posR2==1)&&(dirR2==1))))] (0:0:0 - 1)
		...
		if (!( !(((now.posR2==1)&&(now.dirR2==1)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 34: // STATE 27 - _spin_nvr.tmp:27 - [((!(((posR2==1)&&(dirR2==1)))&&!((dirR2==-(1)))))] (30:0:0 - 1)
		...
		;
		_m = 3; goto P999; /* 2 */
	case 35: // STATE 33 - _spin_nvr.tmp:31 - [(!(((posR1==NS)&&(dirR1==-(1)))))] (0:0:0 - 1)
		...
		if (!( !(((now.posR1==now.NS)&&(now.dirR1== -(1))))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 36: // STATE 35 - _spin_nvr.tmp:32 - [((!(((posR1==NS)&&(dirR1==-(1))))&&!((dirR1==1))))] (38:0:0 - 1)
		...
		;
		_m = 3; goto P999; /* 2 */
	case 37: // STATE 41 - _spin_nvr.tmp:36 - [(!(((posR1==1)&&(dirR1==1))))] (0:0:0 - 1)
		...
		if (!( !(((now.posR1==1)&&(now.dirR1==1)))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 38: // STATE 43 - _spin_nvr.tmp:37 - [((!(((posR1==1)&&(dirR1==1)))&&!((dirR1==-(1)))))] (46:0:0 - 1)
	...
	case 39: // STATE 50 - _spin_nvr.tmp:41 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* CLAIM p0 */
	case 40: // STATE 1 - _spin_nvr.tmp:3 - [(!(((posR1!=posR2)||(dirR1!=dirR2))))] (6:0:0 - 1)
	...
	case 41: // STATE 10 - _spin_nvr.tmp:8 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC :init: */
	case 42: // STATE 1 - ModeleCentralise.pml:19 - [((((dirR1==1)&&((posR2!=(posR1+1))||(dirR1!=dirR2)))&&(posR1<NS)))] (4:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 43: // STATE 5 - ModeleCentralise.pml:21 - [((((dirR1==-(1))&&((posR2!=(posR1-1))||(dirR1!=dirR2)))&&(posR1>1)))] (8:0:1 - 1)
		IfNotBlocked
		reached[0][5] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 44: // STATE 9 - ModeleCentralise.pml:25 - [((((dirR1==1)&&(posR1==NS))&&((posR2!=posR1)||(dirR2!=-(1)))))] (29:0:1 - 1)
		IfNotBlocked
		reached[0][9] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 45: // STATE 12 - ModeleCentralise.pml:27 - [((((dirR1==-(1))&&(posR1==1))&&((posR2!=posR1)||(dirR2!=1))))] (29:0:1 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 46: // STATE 15 - ModeleCentralise.pml:33 - [((((dirR2==1)&&((posR1!=(posR2+1))||(dirR1!=dirR2)))&&(posR2<NS)))] (18:0:1 - 1)
		IfNotBlocked
		reached[0][15] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 47: // STATE 19 - ModeleCentralise.pml:35 - [((((dirR2==-(1))&&((posR1!=(posR2-1))||(dirR1!=dirR2)))&&(posR2>1)))] (22:0:1 - 1)
		IfNotBlocked
		reached[0][19] = 1;
		...
		;
		_m = 3; goto P999; /* 1 */
	case 48: // STATE 23 - ModeleCentralise.pml:39 - [((((dirR2==1)&&(posR2==NS))&&((posR2!=posR1)||(dirR1!=-(1)))))] (29:0:1 - 1)
		IfNotBlocked
		reached[0][23] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 49: // STATE 26 - ModeleCentralise.pml:41 - [((((dirR2==-(1))&&(posR2==1))&&((posR2!=posR1)||(dirR1!=1))))] (29:0:1 - 1)
		IfNotBlocked
		reached[0][26] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 50: // STATE 32 - ModeleCentralise.pml:44 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][32] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
